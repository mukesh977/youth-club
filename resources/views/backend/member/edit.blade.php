...
<div class="content">
    <div class="container-fluid">
        <form action="{{ route('backend.department_member.update',$member->id) }}" method="post"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="full_name" class="form-control" name="full_name"
                                    value="{{ old('full_name')?old('full_name'):$member->full_name }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="club_designation" class="form-control" name="club_designation"
                                    value="{{ old('club_designation')?old('club_designation'):$member->club_designation }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="designation" class="form-control" name="designation"
                                    value="{{ old('designation')?old('designation'):$member->designation }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description">
                                    {{ old('description')?old('description'):$member->description }}
                                </textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="link_to_facebook" class="form-control" name="link_to_facebook"
                                    value="{{ old('link_to_facebook')?old('link_to_facebook'):$member->link_to_facebook }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="link_to_twitter" class="form-control" name="link_to_twitter"
                                    value="{{ old('link_to_twitter')?old('link_to_twitter'):$member->link_to_twitter }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="link_to_instagram" class="form-control" name="link_to_instagram"
                                    value="{{ old('link_to_instagram')?old('link_to_instagram'):$member->link_to_instagram }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="link_to_linkedIn" class="form-control" name="link_to_linkedIn"
                                    value="{{ old('link_to_linkedIn')?old('link_to_linkedIn'):$member->link_to_linkedIn }}">
                            </div>
                            <div class="form-group">
                                <label for="company_name">Company Name</label>
                                <input type="text" id="company_name" class="form-control" name="company_name"
                                    value="{{ old('company_name')?old('company_name'):$member->company_name }}">
                            </div>
                            <div class="form-group">
                                <label for="company_description">Company Description</label>
                                <textarea name="company_description" id="company_description">
                                    {{ old('company_description')?old('company_description'):$member->company_description }}
                                </textarea>
                            </div>
                            <div class="form-group">
                                <label for="company_phone">Company Phone</label>
                                <input type="text" id="company_phone" class="form-control" name="company_phone"
                                    value="{{ old('company_phone')?old('company_phone'):$member->company_phone }}">
                            </div>
                            <div class="form-group">
                                <label for="company_address">Company Address</label>
                                <input type="text" id="company_address" class="form-control" name="company_address"
                                    value="{{ old('company_address')?old('company_address'):$member->company_address }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="company_website_link" class="form-control"
                                    ...
                                    value="{{ old('company_website_link')?old('company_website_link'):$member->company_website_link }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="department_id" name="department_id">
                                    ...
                                    <option value="{{ $item->id }}"
                                        {{ (old('department_id') == $item->id)?'selected':( ($member->department_id == $item->id)?'selected':'') }}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="order" class="form-control" name="order"
                                    value="{{ old('order')?old('order'):$member->order }}">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img src="{{ asset(Storage::url($member->image)) }}" alt="image.jpeg" class="rounded"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img src="{{ asset(Storage::url($member->organization_image)) }}" alt="image.jpeg" class="rounded"
