        ...
        <div class="inner-apply-form">
            ...
            <div class="iaf-body">
                <form method="get" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-9">
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap name"><input type="text" name="name"
                                                value="{{ old('name')?old('name'):$membership->name }}" size="40"
                                    ...
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap parent_name">
                                            <input type="text" name="parent_name"
                                                value="{{ old('parent_name')?old('parent_name'):$membership->parent_name }}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap dob"><input type="text" name="dob"
                                                        value="{{ old('dob')?old('dob'):$membership->dob }}" size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                            ...
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap citizenship_number">
                                                    <input type="text" name="citizenship_number"
                                                        value="{{ old('citizenship_number')?old('citizenship_number'):$membership->citizenship_number }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"
                                ...
                                <div class="col-lg-9">
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap permanent_address"><input type="text"
                                                ...
                                                value="{{ old('permanent_address')?old('permanent_address'):$membership->permanent_address }}"
                                                size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                aria-required="true" aria-invalid="false" placeholder=""
                                                style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                ...
                                <div class="col-lg-9">
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap temporary_address"><input type="text"
                                                ...
                                                value="{{ (old('temporary_address'))?old('temporary_address'):$membership->temporary_address }}"
                                                size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                aria-required="true" aria-invalid="false" placeholder=""
                                                style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap blood_group"><input type="text"
                                                        name="blood_group"
                                                        value="{{ (old('blood_group'))?old('blood_group'):$membership->blood_group }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap marital_status"><input type="text"
                                                        name="marital_status"
                                                        value=" {{ (old('marital_status'))?old('marital_status'):$membership->marital_status }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                    ...
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap email_address">
                                            <input type="email" name="email_address"
                                                value="{{ (old('email_address'))?old('email_address'):$membership->email_address }}"
                                                size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                aria-required="true" aria-invalid="false" placeholder=""
                                                style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"
                                            ...
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap telephone">
                                                    <input type="tel" name="telephone"
                                                        value="{{ (old('telephone'))?old('telephone'):$membership->telephone }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap mobile"><input type="tel"
                                                        name="mobile"
                                                        value="{{ (old('mobile'))?old('mobile'):$membership->mobile }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                ...
                                <div class="col-lg-9">
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap academic_qualification"><input type="text"
                                                ...
                                                value="{{ (old('academic_qualification'))?old('academic_qualification'):$membership->academic_qualification }}"
                                                size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                aria-required="true" aria-invalid="false" placeholder=""
                                                style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                            ...
                            <div class="col-lg-6">
                                <div class="iafbp-single">
                                    ...
                                    <input type="radio" id="business" name="purpose" value="business"
                                        {{ ($membership->purpose == 'business')?'checked':'' }}>
                            ...
                            <div class="col-lg-6">
                                <div class="iafbp-single">
                                    ...
                                    <input type="radio" id="job" name="purpose" value="job"
                                        {{ ($membership->purpose == 'job')?'checked':'' }}>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="iafbp-single">
                                    ...
                                    <input type="radio" id="newBusiness" name="purpose" value="newBusiness"
                                        {{ ($membership->purpose == 'newBusiness')?'checked':'' }}>
                            ...
                            <div class="col-lg-6">
                                <div class="iafbp-single">
                                    ...
                                    <input type="radio" id="abroadReturn" name="purpose" value="abroadReturn"
                                        {{ ($membership->purpose == 'abroadReturn')?'checked':'' }}>
                                ...
                                <div class="col-lg-9">
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap business_name"><input type="text"
                                                name="business_name"
                                                value="{{ (old('business_name'))?old('business_name'):$membership->business_name }}"
                                                size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                aria-required="true" aria-invalid="false" placeholder=""
                                                style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                ...
                                <div class="col-lg-9">
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap business_nature"><input type="text"
                                                ...
                                                value="{{ (old('business_nature'))?old('business_nature'):$membership->business_nature }}"
                                                size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                aria-required="true" aria-invalid="false" placeholder=""
                                                style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                ...
                                <div class="col-lg-9">
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap designation"><input type="text"
                                                name="designation"
                                                value="{{ (old('designation'))?old('designation'):$membership->designation }}"
                                                size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                aria-required="true" aria-invalid="false" placeholder=""
                                                style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                ...
                                <div class="col-lg-9">
                                    <div class="iaf-right">
                                        <span class="wpcf7-form-control-wrap business_address"><input type="text"
                                                ...
                                                value="{{ (old('business_address'))?old('business_address'):$membership->business_address }}"
                                                size="40"
                                                class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                aria-required="true" aria-invalid="false" placeholder=""
                                                style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap business_phone"><input type="text"
                                                        name="business_phone"
                                                        value="{{ (old('business_phone'))?old('business_phone'):$membership->business_phone }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap business_mobile_number"><input
                                                        ...
                                                        value="{{ (old('business_mobile_number'))?old('business_mobile_number'):$membership->business_mobile_number }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap business_email"><input type="text"
                                                        name="business_email"
                                                        value="{{ (old('business_email'))?old('business_email'):$membership->business_email }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="iaf-right">
                                                <span class="wpcf7-form-control-wrap business_website"><input
                                                        ...
                                                        value="{{ (old('business_website'))?old('business_website'):$membership->business_website }}"
                                                        size="40"
                                                        class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-control"
                                                        aria-required="true" aria-invalid="false" placeholder=""
                                                        style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;"></span>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="ifabt-single">
                                                ...
                                                <input type="radio" id="single" name="business_type" value="single"
                                                    {{ ($membership->business_type == 'single')?'checked':'' }}>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="ifabt-single">
                                                ...
                                                <input type="radio" id="group" name="business_type" value="group"
                                                    {{ ($membership->business_type == 'group')?'checked':'' }}>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="ifabt-single">
                                                ...
                                                <input type="radio" id="limited" name="business_type" value="limited"
                                                    {{ ($membership->business_type == 'limited')?'checked':'' }}>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="ifabt-single">
                                                ...
                                                <input type="radio" id="private" name="business_type" value="private"
                                                    {{ ($membership->business_type == 'private')?'checked':'' }}>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="iafb-msg">
                        ...
                        <textarea id="plan_to_upgrade_club_and_business" name="plan_to_upgrade_club_and_business"
                            ...
                            spellcheck="false">{{ (old('plan_to_upgrade_club_and_business'))?old('plan_to_upgrade_club_and_business'):$membership->plan_to_upgrade_club_and_business }}</textarea>
                    </div>
                    <div class="iafb-msg">
                        ...
                        <textarea id="reason_to_join" name="reason_to_join" style="height:120px; width:100%;"
                            spellcheck="false">{{ (old('reason_to_join'))?old('reason_to_join'):$membership->reason_to_join }}</textarea>
                    </div>
                    <div class="iafb-docs pm">
                        ...
                        <div class="iafbd-single">
                            <div class="form-group">
                                ...
                                <img src="{{ asset(Storage::url($membership->pp_photo)) }}" alt="">
                            </div>
                            <div class="form-group">
                                <label>Copy of Citizenship (नागरिकतको प्रतिलिपि)</label><br>
                                <img src="{{ asset(Storage::url($membership->citizenship)) }}" alt="">
                            </div>
                            <div class="form-group">
                                <label>Copy of Business Registration (व्यव्साय दर्ता गरेको प्रतिलिपि)</label><br>
                                <img src="{{ asset(Storage::url($membership->business_registration)) }}" alt="">
                            </div>
                            <div class="form-group">
                                <label>Copy of job ID card if job holder (पेसा गरेको भएमा आफ्नो परिचय पत्र)</label><br>
                                <img src="{{ asset(Storage::url($membership->id_card)) }}" alt="">
                            </div>
                ...
                <div class="ifab-submit pm">
                    <input type="submit" value="Print" class="wpcf7-form-control wpcf7-submit btn btn-default"
                        onclick="window.print()">
                    <a href="{{ route('backend.membership.index') }}" class="btn btn-danger">Back</a>
                </div>
            </div>
        </div>
    </div>
