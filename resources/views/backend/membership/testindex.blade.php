...
<div id="myModal" class="modal">
 Modal content 
    <div class="modal-content">
        ...
        <a href="#" target="_blank"> <img src="{{ asset('frontend/images/popupmodal.jpg') }}" alt=""></a>
    </div>
</div>
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <img src="{{ asset('frontend/images/popupmodal.jpg') }}" alt="">
    </div>
...
<!--<section class="pop-up sec-padding">-->
<!--    <div class="container">-->
<!--        <div class="modal-pop">-->
<!-- Trigger/Open The Modal -->
<!--<button id="myBtn">Pop Up Ad Here</button>-->
<!-- The Modal -->
<!--        </div>-->
<!--    </div>-->
<!--</section>-->
