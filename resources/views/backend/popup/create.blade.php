...
<div class="content">
    <div class="container-fluid">
        <form action="{{ route('backend.popup.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-9">
                    <div class="card card-primary card-tabs">
                        <div class="card-header">
                            <h3 class="card-title">Add Popup Notice</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="status" value="1">
                                <label class="form-check-label" for="flexSwitchCheckDefault">Active
                                </label>
                            </div>
                            <div class="form-group">
