                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control" name="project_title"
                                    value="{{ old('project_title')?old('project_title'):'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="project_initiated_date" class="form-control"
                                    ...
                                    value="{{ old('project_initiated_date')?old('project_initiated_date'):'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="project_status" class="form-control" name="project_status"
                                    value="{{ old('project_status')?old('project_status'):'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="fund_collected" class="form-control" name="fund_collected"
                                    value="{{ old('fund_collected')?old('fund_collected'):'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="members_involved" class="form-control" name="members_involved"
                                    value="{{ old('members_involved')?old('members_involved'):'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="rescued_victim" class="form-control" name="rescued_victim"
                                    value="{{ old('rescued_victim')?old('rescued_victim'):'' }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="project_category" class="form-control" id="project_category">
                                    ...
                                    <option value="present" {{ (old('project_category')=='present')?'selected':'' }}>
                                        Present</option>
                                    <option value="past" {{ (old('project_category')=='past')?'selected':'' }}>Past
                                    </option>
                                    <option value="future" {{ (old('project_category')=='future')?'selected':'' }}>
                                        Future</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="project_first_description" id="project_first_description">
                                    {{ old('project_first_description')?old('project_first_description'):'' }}
                                </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="project_second_description" id="project_second_description">
                                    {{ old('project_second_description')?old('project_second_description'):'' }}
                                </textarea>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img src="{{ asset('frontend/images/youth.png') }}" alt="image.jpeg" class="rounded"
                                    id="project_cover_image" height="200px" width="200px">
                            </div>
                        </div>
                        <!-- /.card-body -->
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img src="{{ asset('frontend/images/youth.png') }}" alt="image.jpeg" class="rounded"
                                    id="project_first_featured_image" height="200px" width="200px">
                            </div>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img src="{{ asset('frontend/images/youth.png') }}" alt="image.jpeg" class="rounded"
                                    id="project_second_featured_image" height="200px" width="200px">
                            </div>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img src="{{ asset('frontend/images/youth.png') }}" alt="image.jpeg" class="rounded"
                                    id="project_third_featured_image" height="200px" width="200px">
                            </div>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer">
