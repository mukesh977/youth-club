...
<div class="content">
    <div class="container-fluid">
        <form action="{{ route('backend.sponser.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-9">
                    <div class="card card-primary card-tabs">
                        <div class="card-header">
                            <h3 class="card-title">Add sponser</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="link" class="form-control" name="link"
                                    ...
                                    <span class="form-text text-muted">Note: This link is the external link of sponser's advertisement. Eg: facebook.com/ultrabyte-advertisement.</span>
                            </div>
